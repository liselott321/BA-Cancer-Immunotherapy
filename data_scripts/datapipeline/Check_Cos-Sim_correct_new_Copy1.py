...
tcr_to_pos_train = pos_train.to_dict()
tcr_to_pos_val = pos_val.to_dict()
...
for df, name, tcr_dict in [
    (train_df, "Train", tcr_to_pos_train),
    (val_df, "Validation", tcr_to_pos_val),
    (test_df, "Test", tcr_to_pos_test)
]:
    def max_sim(row):
