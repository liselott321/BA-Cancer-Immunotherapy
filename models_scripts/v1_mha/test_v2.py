...
assert "task" in test_data.columns, "❌ 'task'-Spalte fehlt in Testdaten für TPP-Auswertung!"
...
artifact_name = "ba_cancerimmunotherapy/dataset-allele/beta_allele:v9" #anpassen, wenn andere version latest
