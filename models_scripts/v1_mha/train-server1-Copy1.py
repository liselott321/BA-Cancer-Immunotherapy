...
from models.morning_stars_v1.beta.v1_ca import TCR_Epitope_Transformer_Cross, LazyTCR_Epitope_Dataset, TCR_Epitope_Dataset, AttentionBlock
...
model = TCR_Epitope_Transformer_Cross(
    config['embed_dim'],
    config['num_heads'],
    config['num_layers'],
