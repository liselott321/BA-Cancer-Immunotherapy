...
# ========== Initialization Train & Validation   ==========
best_ap = 0.0
...
for epoch in range(epochs):
    ...
    # F1, Accuracy, Precision, Recall etc. with best_threshold (not used)
