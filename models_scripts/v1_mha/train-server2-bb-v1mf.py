...
from models.morning_stars_v1.beta.v1_mha_1024_more_features import TCR_Epitope_Transformer, LazyTCR_Epitope_Dataset #, TCR_Epitope_Dataset
...
# Vokabulargrößen für Embedding-Module im Modell
