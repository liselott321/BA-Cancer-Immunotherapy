...
from models.morning_stars_v1.beta.v1_mha_multimodal_physmeta import TCR_Epitope_Transformer_WithDescriptors, LazyTCR_Epitope_Descriptor_Dataset
...
# Save best model -------------------------------------------------------------------------------
if best_model_state:
    os.makedirs("results/trained_models/v1_mha_multimodal", exist_ok=True)
