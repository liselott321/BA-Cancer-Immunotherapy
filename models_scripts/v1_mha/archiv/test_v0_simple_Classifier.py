...
from models.morning_stars_v1.beta.O__v0_simpleClassifier import SimpleTCRClassifier, LazyTCR_Epitope_Dataset
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '../')))
...
artifact_name = "ba_cancerimmunotherapy/dataset-allele/Run_v0_simplyClassifierh_model:v0"
