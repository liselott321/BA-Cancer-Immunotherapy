...
from models.morning_stars_v1.beta.v5_ple_offline import TCR_Epitope_Transformer, LazyTCR_Epitope_Descriptor_Dataset
...
for epoch in range(epochs):
    ...
    current_model_path = "results/trained_models/v5_new/v5_new_over.pt"
    os.makedirs("results/trained_models/v5_new", exist_ok=True)
...
# Save best model -------------------------------------------------------------------------------
if best_model_state:
    best_model_path = "results/trained_models/v5_new/best_model.pt"
